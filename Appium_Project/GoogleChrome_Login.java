...
public class GoogleChrome_Login {
    WebDriverWait wait;
    ...
    public void scrollIntoViewTest() {
     ...
     wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("android.view.View[2]/android.view.View/android.view.View[6]")));
