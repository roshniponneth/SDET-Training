...
public class Activity14_2a {
    ...
    public void writeExcel(String filePath) throws IOException {
        ...
        String[] row1 = {"1", "Amrith", "Ponneth", "amrpon@example.com", "4537829158"};
        String[] row2 = {"2", "Manoj", "Chandra", "manch@example.com", "4892184058"};
        String[] row3 = {"3", "Roshni", "Ponneth", "ropo@example.com", "4528727830"};
