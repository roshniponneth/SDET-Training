...
public class Activity5 {
  ...
  public void f() {
	//Fill in the login credentials
	  ...
	  driver.findElement(By.id("personal_txtEmpFirstName")).sendKeys("Roshni");
	  driver.findElement(By.id("personal_txtEmpLastName")).clear();
	  driver.findElement(By.id("personal_txtEmpLastName")).sendKeys("Ponneth");	  
	  //Fill in Gender
	  ...
	  driver.findElement(By.id("personal_DOB")).sendKeys("1982-06-20");
